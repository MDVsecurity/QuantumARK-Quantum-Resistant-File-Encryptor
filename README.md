...
<img src="[https://semgrep.dev/img/semgrep-icon-text-horizontal.svg](https://commons.wikimedia.org/wiki/File:Semgrep_logo.svg")" alt="Semgrep Analysis" height="40" style="margin: 10px;">
