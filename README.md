...
<div align="center"> <img src="https://raw.githubusercontent.com/PyCQA/bandit/main/logo/logotype-sm.png" alt="Bandit Security" height="40" style="margin: 10px;"> <img src="https://semgrep.dev/img/semgrep-icon-text-horizontal.svg" alt="Semgrep Analysis" height="40" style="margin: 10px;"> <img src="https://img.shields.io/badge/🔍-Continuous%20Monitoring-blue?style=for-the-badge" alt="Continuous Monitoring" style="margin: 10px;"> </div>
Show Image
...
Abre QuantumARK
Ve a la pestaña "[LOCK] Cifrar Archivo"
Selecciona tu archivo
Crea una contraseña fuerte
¡Click en "Cifrar" y listo! 🎉
2️⃣ Descifrar un Archivo
Ve a "[UNLOCK] Descifrar Archivo"
Selecciona tu archivo .qr256
Ingresa tu contraseña
¡Tu archivo original será restaurado! ✅
...
Checksum SHA-256 del archivo original
Metadatos firmados con timestamp
Verificación de padding PKCS7
...
Push a la branch (git push origin feature/amazing-feature)
Abre un Pull Request
🐛 Reportar Bugs
Usa nuestro template de issues e incluye:
...
🔄 Compártelo con colegas y amigos
